                                                            ...
                                                            <div class="d-flex gap-3">
                                                                ...
                                                                <div class="">
                                                                    ...
                                                                    <p class="name-text mb-1"> Bank : <span
                                                                            class="name-para">{{ $add->bank_name }}</span>
                                                                    </p>
                                                                    <p class="name-text mb-1"> Mo.No : <span
                                                                            class="name-para">{{ $add->mobile }}</span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class="">
                                                                ...
                                                                <p class="name-text mb-1">
                                                                    Rs.{{ $data->provide_help_ammount }} </p>
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="hidden"
                                                                                            name="get_ammmount"
                                                                                            value="{{ $data->provide_help_ammount }}">
                                                                                    </div>
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    ...
                                                                                    <button type="submit"
                                                                                        class="btn btn-primary">Uploade</button>
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </div>
                                                                ...
                                                                <div class="details-tip">
                                                                    ...
                                                                    <div class="tooltip-content details-div">
                                                                        ...
                                                                        <p class="name-text mb-1"> Ifsc Code : <span
                                                                                class="name-para">{{ $add->ifsc_code }}</span>
                                                                        </p>
                                                                        <p class="name-text mb-1"> Account No: <span
                                                                                class="name-para">{{ $add->account_no }}</span>
                                                                        </p>
                                                                        <p class="name-text mb-1"> Upi Link: <span
                                                                                class="name-para">{{ $add->upi_link }}</span>
                                                                        </p>
                                                                        <p class="name-text mb-1"> Phone Pay No: <span
                                                                                class="name-para">{{ $add->phone_pay_no }}</span>
                                                                        </p>
                                                                        <p class="name-text mb-1"> Google Pay No: <span
                                                                                class="name-para">{{ $add->google_pay_no }}</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class=" d-flex justify-content-between">
                                                                <div class="d-flex gap-3">
                                                                    ...
                                                                    <div class="">
                                                                        ...
                                                                        <p class="name-text mb-1"> Bank : <span
                                                                                class="name-para">{{ $row->bank_name }}</span>
                                                                        </p>
                                                                        <p class="name-text mb-1"> Mo.No : <span
                                                                                class="name-para">{{ $row->mobile }}</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                <div class="">
                                                                    <p class="name-text mb-1">47:38:25</p>
                                                                    <p class="name-text mb-1">Rs.
                                                                        {{ $row->provide_help_ammount }}</p>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-xl-12 d-flex justify-content-end gap-2">
                                                         ...
                                                         --}}
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input type="hidden"
                                                                                                name="get_ammmount"
                                                                                                value="{{ $row->provide_help_ammount }}">
                                                                                        </div>
                                                                    ...
                                                                    <div class="details-tip">
                                                                        ...
                                                                        <div class="tooltip-content details-div">
                                                                            ...
                                                                            <p class="name-text mb-1"> Ifsc Code : <span
                                                                                    class="name-para">{{ $row->ifsc_code }}</span>
                                                                            </p>
                                                                            <p class="name-text mb-1"> Account No: <span
                                                                                    class="name-para">{{ $row->account_no }}</span>
                                                                            </p>
                                                                            <p class="name-text mb-1"> Upi Link: <span
                                                                                    class="name-para">{{ $row->upi_link }}@yb</span>
                                                                            </p>
                                                                            <p class="name-text mb-1"> Phone Pay No: <span
                                                                                    class="name-para">{{ $row->phone_pay_no }}</span>
                                                                            </p>
                                                                            <p class="name-text mb-1"> Google Pay No: <span
                                                                                    class="name-para">{{ $row->google_pay_no }}</span>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <form action="{{ route('user.conformetion', $conf->sender_id) }}"
                                                            ...
                                                            <div class="col-xl-12 d-flex justify-content-end gap-2">
                                                                ...
                                                                @if ($conf->tran_status == '1')
                                                                    <button type="button"
                                                                        class="btn btn-payment">Conformation Done</button>
                                                                @else
                                                                    <button type="submit"
                                                        ...
                                                        <div class="details-tip">
                                                            ...
                                                            <div class="tooltip-content details-div">
                                                                ...
                                                                <p class="name-text mb-1"> Mobile No. : <span
                                                                        class="name-para">{{ $conf->mobile }}</span></p>
                                                                <p class="name-text mb-1"> Ifsc Code : <span
                                                                        class="name-para">{{ $conf->ifsc_code }}</span>
                                                                </p>
                                                                <p class="name-text mb-1"> Account No: <span
                                                                        class="name-para">{{ $conf->account_no }}</span>
                                                                </p>
                                                                <p class="name-text mb-1"> Upi Link: <span
                                                                        class="name-para">{{ $conf->upi_link }}</span></p>
                                                                <p class="name-text mb-1"> Phone Pay No: <span
                                                                        class="name-para">{{ $conf->phone_pay_no }}</span>
                                                                </p>
                                                                <p class="name-text mb-1"> Google Pay No: <span
                                                                        class="name-para">{{ $conf->google_pay_no }}</span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="row">
                                    <div class="col-xl-4 mb-3 form-class form-adjust">
                                        <label>State</label>
                                        <input class="form-control" placeholder="Punjab" name="state"
                                            value="{{ Auth::user()->state }}"></input>
                                    </div>
                                    <div class="col-xl-4 mb-3 form-class form-adjust">
                                        <label>City</label>
                                        <input class="form-control" placeholder="Ludhiana" name="city"
                                            value="{{ Auth::user()->city }}"></input>
                                    </div>
                                    <div class="col-xl-4 mb-3 form-class form-adjust">
                                ...
                                <div class="row">
                                    <div class="col-xl-6 mb-3 form-class form-adjust">
                                        ...
                                        <input type="text" placeholder="SBIN001992" class="form-control"
                                            name="ifsc_code" value="{{ Auth::user()->ifsc_code }}"
                                            onkeyup="
