                                                    ...
                                                    @if($user->tran_status != '2')
                                                        <div class="pay-card responsive-card">
                                                            <div class=" d-flex justify-content-between">
                                                                ...
                                                                <div class="">
                                                                    <input type="hidden" id="start_date_timer_{{$user->id}}" class="start_date_timer" data-id="{{$user->id}}"
                                                                        value="{{ isset($currentDate) && !empty($currentDate) ? $currentDate : date("
                                                                        Y-m-d h:i:s") }}">
                                                                    <input type="hidden" id="end_date_timer_{{$user->id}}" class="end_date_timer"
                                                                        value="{{ $user->end_date }}">
                                                                    <input type="hidden" id="payment_success_date_{{$user->id}}" class="payment_success_date"
                                                                        value="{{ $user->payment_success_date }}">
                                                                    <input type="hidden" id="payment_status_{{$user->id}}" class="payment_status"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-12 d-flex justify-content-end gap-2">
                                                                    ...
                                                                    <button type="button" class="btn btn-payment" data-toggle="modal"
                                                                        data-target="#exampleModal{{$user->id}}" data-whatever="@mdo">Payment Image</button>
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <div class="form-group">
                                                                                            <label for="formFileMultiple" class="form-label">Payment Image</label>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12 d-flex justify-content-end gap-2">
                                                    ...
                                                    <button type="button" class="btn btn-payment examps" data-toggle="modal"
                                                        data-target=".{{ $show->id }}-modal-lg" data-id="{{ $show->user_id }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <form action="{{ route('user.conformetion', $conf->sender_id) }}" method="POST">
                                                ...
                                                <div class="col-xl-12 d-flex justify-content-end gap-2">
                                                    ...
                                                    <button type="button" class="btn btn-payment examps" data-toggle="modal"
                                                        data-target=".{{ $conf->id }}-modal5-lg"
                                                        data-id="{{ $conf->user_id }}" data-image="{{ $conf->image }}">View
                                                        Image</button>
                                                    ...
                                                    <div class="modal fade bd-example-modal-lg {{ $conf->id }}-modal5-lg"
                                                        tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                ...
                                                                <img id="image"
                                                                    src="{{ asset('user/assets/img/payment/'.$conf->image) }}" />
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="pay-card responsive-card">
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-12 d-flex justify-content-end gap-2">
                                                        ...
                                                        <button type="button" class="btn btn-payment" data-toggle="modal"
                                                            data-target=".{{ $show->id }}-modal3-lg" data-id="{{ $show->show }}"
                                                            data-image="{{ $show->image }}">View
                                                            Image</button>
